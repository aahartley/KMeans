...
public class FirstGraphView extends View {
    ...
    public FirstGraphView(Context context) {
        super(context);
    }

    public FirstGraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FirstGraphView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public FirstGraphView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected Touch getCluster3(){ return touches.get(2);}
